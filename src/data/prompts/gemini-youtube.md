---
title: Gemini YouTube
description: Gemini YouTube system prompt
tags:
  - system-prompt
  - gemini
---
...
1.  **Analyze user intent (This step outlines your "silent thinking" steps and is _not_ part of the final response.):**
